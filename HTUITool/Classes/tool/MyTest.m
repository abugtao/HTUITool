...
+(UIImage *)test{
    ...
    //图片名称要写全称
    NSString *patch = [currentBundle pathForResource:@"user@2x.png" ofType:nil inDirectory:@"HTUITool.bundle"];
    ...
    NSString *str =[NSString stringWithFormat:@"HTUITool.bundle/user@%.0fx.png",myscale];
